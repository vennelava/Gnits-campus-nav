...
// import { MapPin, Navigation, ArrowUp, ArrowDown, ArrowRight, ArrowLeft, Building2, Search } from 'lucide-react';

// // Complete room database with coordinates
// const ROOM_DATABASE = {
//   CSE: {
//     name: "CSE Block",
//     color: "#9333ea",
...
//   const [currentView, setCurrentView] = useState('input'); // 'input', 'route', 'map'
...
//         const distance = fromRoomData.coords && toRoomData.coords 
...
//           text: `Walk ${Math.round(distance)}m along the corridor to ${toRoom}`,
//           block: fromBlock,
//           floor: fromFloor
//         });
//       } else {
//         // Different floors, same block
//         steps.push({
//           type: 'start',
//           icon: <MapPin className="w-5 h-5" />,
...
//       // Navigate to ground floor if not already there
//       if (fromFloor !== '0') {
//         steps.push({
//           type: 'stairs',
